...
class SessionWorkItemOutcome(Base, SyncMixin):
    ...
    execution_persona: Mapped[str | None] = mapped_column(String(32))
    persona_switched: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    persona_note: Mapped[str | None] = mapped_column(String(500))
