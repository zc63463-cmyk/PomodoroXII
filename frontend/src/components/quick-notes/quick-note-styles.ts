export const quickNoteStyles = {
  ...
  textareaFocus:
    'min-h-[22rem] resize-y rounded-[1.625rem] border border-[color:var(--qn-border)] bg-[color:var(--qn-field)] px-5 py-4 text-lg leading-8 text-[color:var(--qn-text-strong)] outline-none transition-all duration-300 placeholder:text-[color:var(--qn-placeholder)] focus:border-[color:var(--qn-border-strong)] focus:bg-[color:var(--qn-field-focus)] focus:ring-3 focus:ring-[color:var(--qn-accent-soft)]',
  workspaceStage:
  ...
  searchWrap:
    'flex items-center gap-2 rounded-[0.9rem] border border-transparent bg-[color:var(--qn-search)] px-3 py-2 shadow-none backdrop-blur-[18px]',
  searchInput:
