...
const definitions = [
  ...
  store('sessionCommandReceipts', 'commandId', [index('spaceId'), index('sessionId'), index('state'), index('receivedAt')]),
  store('sessionCommandReconciliationAttempts', 'attemptId', [index('rootOperationId'), index('state'), index('createdAt')]),
