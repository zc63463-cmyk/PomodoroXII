...
- Create `backend/app/runtime/contained_io.py`: Linux dirfd/openat2/openat/unlinkat and Windows root-HANDLE-relative no-reparse openers, opaque resource-transfer types, and the private authority binding for `pxii-vfs`.
